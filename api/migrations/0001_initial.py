    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialidad_turno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.especialidad')),
                ('medico_turno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.medicos')),
                ('sede_turno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.sede')),
                ('usuario_turno', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='user',
